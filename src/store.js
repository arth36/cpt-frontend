...
export default new Vuex.Store({
  ...
  actions: {
    fetchPortfolioCoins(context) {
      axios({
        method: 'get',
        url: 'https://cpt-project.herokuapp.com/api/portfolio/show',
    ...
    fetchData(context) {
      axios({
        method: 'get',
        url: 'https://cpt-project.herokuapp.com/api/coins/getCoins',
        withCredentials: true
      }).then(res => {
    ...
    fetchFavs(context) {
      axios({
        method: 'get',
        url: 'https://cpt-project.herokuapp.com/api/favCoins/show',
        withCredentials: true
      }).then(res => {
    ...
    fetchICO(context) {
      axios({
        method: 'get',
        url: 'https://cpt-project.herokuapp.com/api/icos/getIcos',
        withCredentials: true
      }).then(res => {
    ...
    fetchMyPosts(context) {
      axios({
        method: 'get',
        url: 'https://cpt-project.herokuapp.com/api/charts/userPosts',
        withCredentials: true
      }).then(res => {
    ...
    fetchProfile(context) {
      axios({
        method: 'get',
        url: 'https://cpt-project.herokuapp.com/api/user/getProfile',
        withCredentials: true
      })
        .then(data => {
